...
import com.example.administrator.flagapitest.mvp.model.BluetoothModel;
...
import static com.example.administrator.flagapitest.ApplicationUtil.acceptThread;
...
import static com.example.administrator.flagapitest.ApplicationUtil.connectThread;
...
public class BluetoothPresenter<T extends MyView> extends Presenter<T> {
    ...
    private BluetoothModel mModel = (BluetoothModel) modelLayer; // 模型层引用

    public BluetoothPresenter() {
        super(new BluetoothModel());
    } // 实例化模型层
